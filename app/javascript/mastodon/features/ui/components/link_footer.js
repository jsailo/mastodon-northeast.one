    ...
    return (
      <div className='getting-started__footer'>
        <ul>
          ...
          <li><a href='https://docs-hello.2heng.xin' target='_blank'><FormattedMessage id='getting_started.documentation' defaultMessage='Documentation' /></a> · </li>
        ...
        <p>
          <FormattedMessage
            ...
            defaultMessage='Software used by northeast.one is open source . You can contribute or report issues on GitHub at {github}.'
